...
INSERT INTO settings (key, value) VALUES
  ...
  ('lead_pool',         '50000'),
  ('lead_purse_team',   '20000'),  -- средний кэф отдела
  ('lead_purse_filter', '15000'),  -- принято владельцем с первого раза
  ('lead_purse_unload', '10000'),  -- задачи, закрытые без владельца
  ('lead_purse_speed',  '5000'),   -- своя скорость 0.4 + командная 0.6
