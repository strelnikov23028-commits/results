#!/usr/bin/env python3
"""
Добавляет в колоду слова из data/extra_words2.json и переносит их сцены
...
def main():
    ...
    new = json.load(open(D("data", "extra_words2.json"), encoding="utf-8"))
