#!/usr/bin/env python3
"""
Добавляет в колоду слова из data/extra_words9.json.
Дубли ищутся по точному написанию, вместе с диакритикой.
"""
import json, os

ROOT = os.path.dirname(os.path.abspath(__file__))
D = lambda *p: os.path.join(ROOT, *p)
SRC = "extra_words9.json"
